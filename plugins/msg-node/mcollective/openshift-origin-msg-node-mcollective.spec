...
%changelog
* Fri Mar 14 2014 Brenton Leanhardt <bleanhar@redhat.com> 1.17.7-1
- Fix for bug 1047957, 1073604 (abhgupta@redhat.com)

* Mon Feb 10 2014 dobbymoodge <jolamb@redhat.com> 1.17.6-1
- Node Platform - Optionally generate application key (jhonce@redhat.com)

* Mon Dec 23 2013 Luke Meyer <lmeyer@redhat.com> 1.17.5-1
- Bug 1032906: Fix generic error handling in Openshift agent #cherrypick
  (ironcladlou@gmail.com)

* Wed Dec 18 2013 Jason DeTiberus <jdetiber@redhat.com> 1.17.4-1
- Report warnings and errors from broker when console gets rest api server
  error (jforrest@redhat.com)

* Fri Dec 13 2013 Jason DeTiberus <jdetiber@redhat.com> 1.17.3-1
