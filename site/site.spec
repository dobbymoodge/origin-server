...
RAILS_ENV=production RAILS_HOST=openshift.redhat.com RAILS_RELATIVE_URL_ROOT=/app \
  ...
  bundle exec rake assets:precompile_digested assets:public_pages assets:generic_error_pages
...
* Thu Jun 06 2013 Adam Miller 1.10.1-5
- Bump spec for site rebuild

* Wed Jun 05 2013 Adam Miller 1.10.1-4
- Bump spec for site rebuild
